...
import catalogRoutes from "../catelog.routes";
import { catalogService } from "../catelog.routes";
...
const mockRequest = () => {
  return {
    ...
    price: faker.number.int({ min: 10 }),
  };
};

describe("Catalog Routes", () => {
  describe("POST /products", () => {
    test("should create product successfuly", async () => {
  ...
  describe("PATCH /products/:id", () => {
    test("should update product successfuly", async () => {
      const product = ProductFactory.build();
